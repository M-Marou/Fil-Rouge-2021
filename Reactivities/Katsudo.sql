...
VALUES ('20210706123943_InitialCreate', '5.0.1');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20210802095206_IdentityAdded', '5.0.1');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20210824144943_ActivityAttendee', '5.0.1');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20210831020050_AddCancelledProperty', '5.0.1');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220103115905_PhotoEntityAdded', '5.0.1');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220105220620_CommentEntityAdded', '5.0.1');

COMMIT;

BEGIN TRANSACTION;

-- ALTER TABLE "Comments" RENAME COLUMN "CreateAt" TO "CreatedAt";

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220105220815_CommentsEntityAdded', '5.0.1');
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20220107084913_FollowingEntityAdded', '5.0.1');
